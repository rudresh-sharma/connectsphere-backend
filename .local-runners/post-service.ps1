...
$Host.UI.RawUI.WindowTitle = 'connectsphere-post-service'
...
Write-Host 'Starting post-service on port 8081...'
...
if ($LASTEXITCODE -ne 0) {
    Write-Host ''
    Write-Host 'post-service stopped with exit code' $LASTEXITCODE -ForegroundColor Red
}
Write-Host ''
