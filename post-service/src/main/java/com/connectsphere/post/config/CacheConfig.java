...
public class CacheConfig implements CachingConfigurer {
    ...
    public static final String POST_DETAILS_CACHE = "postDetails";
/**
    ...
    public CacheManager cacheManager(RedisConnectionFactory redisConnectionFactory) {
        ...
        return RedisCacheManager.builder(redisConnectionFactory)
                ...
                .withInitialCacheConfigurations(Map.of(
                        POST_DETAILS_CACHE, defaults.entryTtl(Duration.ofMinutes(5))
                ))
                .build();
    }
/**
 ...
 */
            ...
            public void handleCacheGetError(RuntimeException exception, Cache cache, Object key) {
                log.warn("Ignoring cache get failure for cache={} key={}", cache.getName(), key, exception);
            }
/**
 ...
 */
            ...
            public void handleCachePutError(RuntimeException exception, Cache cache, Object key, Object value) {
                log.warn("Ignoring cache put failure for cache={} key={}", cache.getName(), key, exception);
            }
/**
 ...
 */
            ...
            public void handleCacheEvictError(RuntimeException exception, Cache cache, Object key) {
                log.warn("Ignoring cache evict failure for cache={} key={}", cache.getName(), key, exception);
            }
/**
